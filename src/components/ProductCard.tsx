      ...
      <div className="flex flex-col gap-4 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="ring ring-gray-200 shadow-lg py-2 px-1 rounded-md text-sm cursor-pointer hover:text-white hover:bg-black transition-all duration-300 flex items-center gap-2"
          >
